 ...
 */
// TODO: annotate this data class as an entity with a parameter for the table name DONE
@Entity(tableName = "forageable_database")
data class Forageable(
    // TODO: declare the id to be an autogenerated primary key DONE
    @PrimaryKey(autoGenerate = true) val id: Long = 0,
    @NonNull val name: String,
    val address: String,
    // TODO: make a custom column name for the inSeason variable that follows SQL column name
    //  conventions (the column name should be in_season) DONE
